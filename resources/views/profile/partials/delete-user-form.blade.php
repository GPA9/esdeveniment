<div class="card">
    <div class="card-header">{{ __('Esborrar compte') }}</div>

    <div class="card-body">
        <div class="mb-3">
            {{ __('Un cop es eliminï el teu compte, tots els seus recursos i dades es eliminaran de manera permanent. Abans de eliminar el teu compte, si us plau, descarrega qualsevol dada o informació que vulguis conservar.') }}
        </div>
